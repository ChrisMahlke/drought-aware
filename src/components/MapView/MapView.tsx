...
import { saveMapLocationInUrlHashParams, getMapLocationFromUrlHashParams, MapCenterLocation } from '../../utils/UrlHashParams';
        ...
        try {
            ...
            watchUtils.whenTrue(mapView, "stationary", () => {
                ...
                const centerLocation: MapCenterLocation = {
                    lat: mapView.center && mapView.center.latitude ? +mapView.center.latitude.toFixed(3) : 0,
                    lon: mapView.center && mapView.center.longitude ? +mapView.center.longitude.toFixed(3) : 0,
                    zoom: mapView.zoom,
                };
