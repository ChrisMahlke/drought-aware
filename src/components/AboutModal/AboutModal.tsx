        ...
        >
            ...
            >
                ...
                <div>
                    ...
                    <p>This app was designed by Esri’s <a className='link-light-blue' href="https://www.esri.com/arcgis-blog/author/dpisut/" target="_blank">Dan Pisut</a>, <a className='link-light-blue' href="https://www.esri.com/arcgis-blog/author/emeriam/" target="_blank">Emily Meriam</a> and <a className='link-light-blue' href="https://github.com/chrismahlke" target="_blank">Jinnan Zhang</a>. The source code for the app can be found on <a className='link-light-blue' href="https://github.com/chrismahlke/drought-aware" target="_blank">GitHub</a>.</p>
                </div>
